...
var SelfAbortTree = (function () {
    function SelfAbortTree() {
        this.state = new State();
        this._distanceToNextLocation = 10;
    }
    SelfAbortTree.prototype.update = function () {
        if (this._tree)
            this._tree.tick();
    };
    SelfAbortTree.prototype.start = function () {
        var builder = BehaviorTreeBuilder.begin(this);
        builder.selector(AbortTypes.Self);
        // 睡觉最重要
        builder.conditionalDecoratorR(function (m) { return m.state.fatigue >= State.MAX_FATIGUE; }, false);
        builder.sequence(AbortTypes.LowerPriority)
            ...
            .endComposite();
        // 喝水第二重要
        builder.conditionalDecoratorR(function (m) { return m.state.thirst >= State.MAX_THIRST; }, false);
        builder.sequence(AbortTypes.LowerPriority)
            .logAction("-- 渴了! 准备喝水")
            ...
            .endComposite();
        // 存钱第三重要
        builder.conditionalDecoratorR(function (m) { return m.state.gold >= State.MAX_GOLD; }, false);
        builder.sequence(AbortTypes.LowerPriority)
    ...
    SelfAbortTree.prototype.digForGold = function () {
    ...
    SelfAbortTree.prototype.drink = function () {
    ...
    SelfAbortTree.prototype.sleep = function () {
    ...
    SelfAbortTree.prototype.goToLocation = function (location) {
    ...
    SelfAbortTree.prototype.depositGold = function () {
        this.state.goldInBank += this.state.gold;
        this.state.gold = 0;
        console.log("\u5B58\u94B1\u8FDB\u5165\u94F6\u884C. \u5F53\u524D\u5B58\u6B3E " + this.state.goldInBank);
        return TaskStatus.Success;
    };
    return SelfAbortTree;
}());
__reflect(SelfAbortTree.prototype, "SelfAbortTree");
//# sourceMappingURL=SelfAbortTree.js.map